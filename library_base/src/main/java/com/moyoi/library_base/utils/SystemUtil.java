...
public class SystemUtil {
    ...
    public static synchronized String getAppName() {
        return getAppName(BaseApplication.context);
    }
    ...
    public static synchronized String getVersionName() {
        return getVersionName(BaseApplication.context);
    }
    ...
    public static synchronized int getVersionCode() {
        return getVersionCode(BaseApplication.context);
    }
    ...
    public static synchronized String getPackageName() {
        return getPackageName(BaseApplication.context);
    }
    ...
    public static void gotoAppDetailsSettings() {
        gotoAppDetailsSettings(BaseApplication.context);
    }
    ...
    public static boolean isServiceRunning(String serviceName) {
        return isRunningService(BaseApplication.context, serviceName);
    }
    ...
    public static boolean isRunningForeground() {
        return isRunningForeground(BaseApplication.context);
    }
    ...
    public static void setTopApp() {
        setTopApp(BaseApplication.context);
    }
    ...
    public static void acquireWakeLock() {
        acquireWakeLock(BaseApplication.context);
    }
