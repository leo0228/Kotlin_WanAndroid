...
import com.moyoi.library_base.utils.ActivityResultHelper.requestRecordAudioPermissions
import com.moyoi.library_base.utils.ActivityResultHelper.requestStoragePermissions
import com.moyoi.library_base.utils.ActivityResultHelper.startForResult
import java.io.File
                ...
                try {
                    ...
                    if (mediaRecorder == null) {
                        ...
                        mediaRecorder?.setVideoSize(
                            MetricsUtil.screenWidth,
                            MetricsUtil.screenHeight
                        )
                        //音频编码
                        mediaRecorder?.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB)
                        //图像编码
                        mediaRecorder?.setVideoEncoder(MediaRecorder.VideoEncoder.H264)
                        val bitRate = MetricsUtil.screenWidth * MetricsUtil.screenHeight * 2.6
                        //设置码率
